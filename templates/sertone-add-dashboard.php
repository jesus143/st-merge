                        ...
                        <div class="col-md-12 table-container">
                                    ...
                                    try {
                                        ...
                                        try { ?>
                                                ...
                                                <table class="table table-bordered" id="applications_container" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th width="100" >
                                                            <span>Action</span>
                                                ...
                                                foreach ($result_application as  $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <?php if($application_default_r['app_eui'] == $value['app_eui']): ?>
                                                            <input type="checkbox" name="selected_application[]" id="selected_application_<?php echo $key; ?>" value="<?php echo $value['app_eui']; ?>" checked/>
                                                       <?php else: ?>
                                                            <input type="checkbox" name="selected_application[]" id="selected_application_<?php echo $key; ?>" value="<?php echo $value['app_eui']; ?>" />
                                                       <?php  endif; ?>
                                                        </td>
							...
							try {
								...
								foreach ($results_gateway as $key => $value) {
									...
									<tr>
										...
										<td><?php  echo $newarray_for_gateways['gateway_eui']  ?></td>
										<td><?php  echo $newarray_for_gateways['id']  ?></td>
										<td><?php  echo $newarray_for_gateways['id']  ?></td>
										<td><?php  echo $newarray_for_gateways['id']  ?></td>
										<td><?php  echo $newarray_for_gateways['id']  ?></td>
