				...
				<div class="col-md-12" style="padding-bottom:20px;">
					...
					<?php if (isset($_POST['second-submit-form'])): ?>
						...
						<div class="third-form fomrs ">
							<form method="post" action="" class="nopadding">
								...
								<br>
								<div class="col-md-3">
									<h3 class="nopadding nomargin">Country: </h3>
								</div>
								<div class="col-md-5">																		
					...
					<?php if (isset($_GET['confirm'])): ?>
						...
						<div class="fourth-form fomrs">
							<form method="post" action="" class="nopadding">
								<h2 class="success">Congratulations! Your gateway is now activated and you can proceed with connecting your sensors! </h2>
